...
export default function ModelShowcaseSection({
  ...
  return (
    <section
      className={cn(
        "w-full p-[8px]",
        "lg:bg-[url('/Bgborder.png')] dark:lg:bg-[url('/darkBgborder.png')] bg-no-repeat bg-center bg-[length:100%_100%] border border-primary/60 lg:border-none rounded-3xl",
        "overflow-hidden",
    ...
    >
      ...
      <div className="grid items-center lg:grid-cols-12 gap-4 lg:gap-16">
        <div
          className={[
            "md:col-span-5 ",
            reverse ? "md:order-2 md:pl-6" : "md:order-1 md:pr-6",
          ].join(" ")}
        >
          <h3 className="text-2xl xl:text-[40px] font-medium">{item.title}</h3>
